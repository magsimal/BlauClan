      ...
      template: `
        <div>
          <div id="toolbar" class="mb-2">
            <button class="btn btn-primary btn-sm btn-icon" @click="addPerson">
              <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
              <span class="btn-inner--text">Add Person</span>
            </button>
          </div>
          <VueFlow
          ...
          >
            <template #node-person="{ data }">
              <div class="person-node" :style="{ borderColor: data.gender === 'female' ? '#f8c' : '#88f' }">
                ...
                <button class="btn btn-sm btn-primary btn-icon add-child" @click.stop="addPerson">
                  <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                </button>
                  ...
                  <div v-if="children.length" class="mb-2">
                    ...
                    <ul>
                      <li v-for="c in children" :key="c.id">
                        ...
                        <button class="btn btn-sm btn-danger btn-icon ml-1" @click="unlinkChild(c)">
